...
DT::datatable(sf1_pop_2010_dt[1:6,], caption = 'Table 2.1: Total population by state, 2010 Census')
```
...
DT::datatable(aian_2020_dt[1:6, ], caption = 'Table 2.2: American Indian or Alaska Native alone population by state from the 2020 decennial Census')
```
...
DT::datatable(born_in_mexico_5yr_dt[1:6,], caption = 'Table 2.3: Mexican-born population by state, 2016-2020 5-year ACS')
```
...
DT::datatable(born_in_mexico_1yr_dt[1:6,], caption = 'Table 2.4 Mexican-born population by state, 2019 1-year ACS')
```
...
DT::datatable(B01001_dt[1:6], caption = 'Table 2.5: Table B01001 by state from the 2016-2020 5-year ACS')
```
...
DT::datatable(B01001_vars_dt[1:6], caption = 'Table 2.5a: Variable descriptions for group B01001 from the 2016-2020 5-year ACS')
```
...
DT::datatable(acs5_geo_dt[1:6], caption = 'Table 2.6a: First 6 available geographies from the 2016-2020 5-year ACS')
```
...
DT::datatable(acs5_cbsa_dt[1:6,], caption = 'Table 2.6: Population by CBSA')
```
...
DT::datatable(wi_income_dt[1:6, ], caption = 'Table 2.7: Median household income by county in Wisconsin')
```
...
DT::datatable(dane_income_dt[1:6,], caption = 'Table 2.8: Median household income in Dane County by Census tract')
```
...
DT::datatable(acs5_vars_dt[1:6, ], caption = 'Table 2.9: Variables in the 2012-2016 5-year ACS')
```
...
DT::datatable(B19001_1yr_dt[1:6,], caption = 'Table 2.10: Household income groups by state 2016 1-year ACS')
```
...
DT::datatable(B19001_1yr_wide_dt[1:6, 1:6], caption = 'Table 2.11: Income table in wide form (57 x 36')
```
...
DT::datatable(cimarron_blocks_dt[1:6,], caption = 'Table 2.12: Households by block in Cimarron County, Oklahoma')
```
...
DT::datatable(ga_dt[1:6,], caption = 'Table 2.14: Georgia dataset in wide form')
```
...
DT::datatable(ga_long_dt[1:6,], caption = 'Table 2.13: Multi-variable dataset for Georgia counties (long form)')
```
...
DT::datatable(queens_components_long_dt, caption = 'Table 2.15: Components of change estimates for Queens County, NY')
```
...
DT::datatable(pep_datasets_ls$data, caption = 'Table 2.15a: Population Estimates Program (pep) related datasets, 2019')
```
...
DT::datatable(louisiana_sex_hisp_dt, caption = 'Table 2.16: Population characteristics for Louisiana')
```
...
DT::datatable(pep_char_vars_dt, caption = 'Table 2.16a: All variables, pep/charagegroups,2019')
```
...
DT::datatable(honolulu_migration_long_dt[1:6,], caption = 'Table 2.17: Migration flows data for Honolulu, HI')
```
