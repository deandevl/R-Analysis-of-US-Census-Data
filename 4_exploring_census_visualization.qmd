...
DT::datatable(ga_dt[1:6,], caption = 'Table 4.1a: Household median income and age across Georgia counties')
```
...
DT::datatable(DP03_0021PE_B01003_001E_dt, caption = "Table 4.1a: Description of 'DP03_0021PE' and B01003_001E, acs/acs1/profile")
```
...
DT::datatable(commute_percent_dt[1:6,], caption = 'Table 4.1: Large metro areas by public transit commuting share')
```
...
DT::datatable(me_pop_dt, caption = 'Table 4.2: Population sizes of counties in Maine')
```
...
DT::datatable(me_income_dt, caption = 'Table 4.2a: Household income of counties in Maine')
```
...
DT::datatable(moe_ranked_dt, caption = 'Table 4.3: Margins of error in Maine')
```
...
DT::datatable(deschutes_val_dt[1:6,], caption = 'Table 4.4: Time series of median home values in Deschutes County, OR')
```
...
DT::datatable(pep_char_vars_dt[name %in% c("AGEGROUP","HISP","NATION","POP","RACE","SEX","STATE"),], caption = "Table 4.5a Variables offered in 'pep/charagegroups', pep/charagegroups, 2019")
```
...
DT::datatable(agegroup_cat_dt[1:8,], caption = "Table 4.5b: Integer value/label pairs for catagory variable 'AGEGROUP'")
```
...
DT::datatable(sex_cat_dt, caption = "Table 4.5c: Integer value/label pairs for catagory variable 'SEX'")
```
...
DT::datatable(ut_dt[1:6,], caption = 'Table 4.5: Age and sex data for Utah from the PEP API')
```
...
DT::datatable(ut_pyramid_plot_dt[1:6,], caption = 'Table 4.6: Filtered and transformed Utah population data')
```
...
DT::datatable(home_vals_dt[1:6,], caption = 'Table 4.7: Median home values by Census tract in the Portland')
```
...
DT::datatable(home_vals_dt[1:6,], caption = 'Table 4.8: Data with NAME column split by comma')
```
...
DT::datatable(county_summary_dt, caption = 'Table 4.9: Summary statistics for Census tracts in Portland-area counties')
```
