...
DT::datatable(hennepin_race_dt[1:6,], caption = 'Table 6.1: Race and ethnicity in Hennepin County, MN')
```
...
DT::datatable(boston_se_data_sf[1:6,], caption = "Table 6.2: Self-employment percentages by ZCTA in the Boston, MA area")
```
...
DT::datatable(DP02_0068P_dt, caption = "Descriptions of DP02_0068P from acs/acs5/profile, 2020")
```
