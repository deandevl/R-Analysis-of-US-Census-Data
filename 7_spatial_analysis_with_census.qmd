...
DT::datatable(gainesville_patients_dt[1:6,], caption = 'Table 7.1: Hypothetical dataset of patients in Gainesville, Florida')
```
...
DT::datatable(patients_joined_sf, caption = 'Table 7.2: Patients dataset after spatial join to Census tracts')
```
...
DT::datatable(tx_cbsa_sf, caption = 'Table 7.3: Large CBSAs in Texas')
```
...
DT::datatable(pct_hispanic_sf[1:6,], caption = 'Table 7.4: Percent Hispanic by Census tract in Texas')
```
...
DT::datatable(hispanic_by_metro_sf[1:6,], caption = 'Table 7.5: Census tracts after spatial join operation')
```
...
DT::datatable(median_by_metro_sf[1:6,], caption = 'Table 7.6: Summarized median Hispanic population by metro')
```
...
DT::datatable(wfh_interpolate_aw_sf[1:6,], caption = 'Area interplolation using sf::st_interpolate_aw')
```
...
DT::datatable(dallas_tracts_median_age_LISA_dt[1:6,.(GEOID,scaled_median_age,lagged_median_age)], caption = "Table 7.8: Local Moran's I results")
```
