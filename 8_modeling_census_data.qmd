...
DT::datatable(ca_urban_data_dt[1:8], caption = "Table 8.1: Prepared data for segregation analysis" )
```
...
DT::datatable(white_hispanic_dissimilar_urban_groups_dt, caption = "Table 8.2: Dissimilarity indices for Hispanic and non-Hispanic white populations, large California urbanized areas" )
```
...
DT::datatable(multiple_diversity_dt, caption = "Table 8.3: Multi-group segregation results for California urban areas" )
```
...
DT::datatable(dfw_data_sf[1:6,], caption = "Table 8.4: Data acquired from RcensusPkg for regression modeling")
```
...
DT::datatable(dfw_data_for_model_sf[1:6,], caption = "Table 8.5: Engineered predictors for regression modeling" )
```
...
DT::datatable(vif_df, caption = "VIF values among the first model predictors" )
...
DT::datatable(vif_df, caption = "VIF values among the second model predictors" )
```
...
DT::datatable(pca_dt[,1:6], caption = "Table 8.6: PCA variable loadings" )
```
...
DT::datatable(dfw_kmeans_freq_dt, rownames = F, width = 70)
```
